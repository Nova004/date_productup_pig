...
<div class= "row">
      <div class = "col-md-4">
      <form action = "../www_employee/register_search.php" method = "post">
      <a href='../www_employee/register_sick.php?'><button type='button' class='btn btn-info'><i class='fas fa-stethoscope' style='font-size:20px;color:white'> สุกรป่วย</i></a>
      </div>
	  <div class = "col-md-4">
	     <center>
...
<div class="col-md-4">
		<div class="card shadow-sm" id="bg_card">
				...
				<div class="card-body">
	              <?php echo "<img class='rounded' width='200' height ='150'src ='img/".$row['sick_img']."'>";?>
                </div>
        <div class="card-body">
        ...
        <h7>วันที่ : <?php echo dates_thai("$row[sickdate]");?></h7>
          ...
          <?php echo"<a href='form-edit_sick.php?sickid=$row[0]'><button type='button' class='btn btn-sm btn-outline-primary'><i class='fas fa-tools' style='font-size:16px;color:blue'> เเก้ไข</i></a>";?>
          <?php echo"<a href='delete.php?sickid=$row[0]'><button type='button' class='btn btn-sm btn-outline-primary'><i class='fas fa-trash-alt' style='font-size:16px;color:blue'> ลบ </i></a>";?>
				</div>
			</div>
    	</div>
<?php
