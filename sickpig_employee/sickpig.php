...
<?php include_once('../includes/header_employee.php') ?>
        ...
        <center> <h3 class="card-title d-inline-block">รายการป่าวย<br><br></h3></center>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          ...
          <table id="dataTable" class="table table-bordered table-striped w-100 " >
            ...
            <?php while($row=mysqli_fetch_array($res)) { ?>
              <tr>
                ...
                <td>
                  <a href="form-edit_sick.php?sickid=<?php echo $row['sickid']; ?>" class="btn btn-sm btn-warning text-white">
