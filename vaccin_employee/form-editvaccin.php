          ...
          <div class="card-body">
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                  ...
                  <input type="text" class="form-control" id="vaccin_Name_eng" name="vaccin_Name_eng" value="<?php echo $row1['vaccin_Name_eng']?>">
              </div>        
              <div class="form-group col-md-4">
                  <label for="date">วันหมดอายุ</label>
                  <input type="date" class="form-control" id="date" name="date" value="<?php echo $row1['date']?>">
              </div>    
            </div>

          </div>
          <div class="card-footer">
          <a href="../www_employee/vaccin.php" class="btn btn-warning float-left">ย้อนกลับ</a>
