...
<div class="col-md-4">
		<div class="card shadow-sm" id="bg_card">
				...
				<div class="card-footer">
					<?php echo"<a href='../inject/inject_search_auto.php?pig_ID=$rs[0]'><button type='button' class='btn btn-sm btn-outline-success'><i class='fas fa-eye'style='font-size:16px;color:blue'> ข้อมูลวัคซีน </i></a>";?>
          <?php echo"<a href='../sickpig/inject_search_auto.php?pig_ID=$rs[0]'><button type='button' class='btn btn-sm btn-outline-primary'><i class='fas fa-heartbeat' style='font-size:16px;color:blue'> อาการป่วย </i></a>";?>
					<?php echo"<a href='../graph/form-search.php?pig_ID=$rs[0]'><button type='button' class='btn btn-sm btn-outline-primary'><i class='fas fa-chart-line' style='font-size:16px;color:blue'> ผลผลิต</i></a>";?>
