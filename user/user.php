...
include_once('../www/connect.php');
  ...
  WHERE userID = '$userID' OR Department = 'พนักงาน'
...
<?php include_once('../includes/header.php') ?>
        ...
        <center> <h3 class="card-title d-inline-block">รายชื่อพนักงาน<br><br></h3></center>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          ...
          <table id="dataTable" class="table table-bordered table-striped w-100 " >
            ...
            <?php while($row=mysqli_fetch_array($res)) { ?>
              <tr>
                ...
                <td>
                  <a href="form-edit_user.php?userID=<?php echo $row['userID']; ?>" class="btn btn-sm btn-warning text-white">
                    <i class="fas fa-edit"></i> เเก้ไข
                  </a> 
                  <a href="delete.php?userID=<?php echo $row['userID']; ?>" onClick="return confirm('คุณต้องการลบข้อมูลนี้หรือไม่');" class="btn btn-sm btn-danger">
