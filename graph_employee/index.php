...
<?php include_once('../graph/r_breed.php') ?>
        ...
        <div class="row">
          <div class="col-lg-6 col-6">
            <div class="small-box bg-info">
              ...
              <center><a href="register.php" class=" nav-link active "><h4>All pig</h4></a></center>
                <center><a href="register.php" class=" nav-link active "><svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" class="bi bi-piggy-bank-fill" viewBox="0 0 16 16">
          ...
          <div class="col-lg-6 col-6">
            <div class="small-box bg-success">
              ...
              <?php $sql1="SELECT COUNT(*) as sumteacher FROM users";
                ...
                <center><a href="" class=" nav-link active "><h4>All employee</h4></a></center>
                <center><a href="" class=" nav-link active "><svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
          ...
          <div class="col-lg-6 col-6">
            <div class="small-box bg-warning">
              ...
              <?php $sql3="SELECT COUNT(*) as sumparent FROM vaccin";
                ...
                <center><a href="vaccin.php" class=" nav-link active "><h4>All vaccin</h4></a></center>
                <center><a href="vaccin.php" class=" nav-link active "><svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" class="bi bi-capsule" viewBox="0 0 16 16">
